...
import com.example.appsensorlocation.adapter.ViewPagerAdapter;
...
public class AboutFragment extends Fragment {
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new AboutFragmentPager(), "About");
        adapter.addFragment(new TipsFragmentPager(), " Tips");
